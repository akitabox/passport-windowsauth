 ...
 *
 * Applications supply credentials for an Active Directory and the strategy will attempt to fetch
 * user profiles
 *
 * @param {Object} options                            - strategy options object
 * @param {Object} options.ldap                       - ldap connection options
 * @param {Boolean} [options.passReqToCallback=false] - when true, req is the first argument
 *                                                      to the verify callback
 * @param {Function} verify                           - callback function for application to validate
